...
<head>
    ...
    <title>TT Voucher Insentif</title>
</head>
...
.table1 tr:nth-child(even) {
    ...
    <table>
        <tr>
            <td>
                <h5 style="position: fixed; margin-top: 0px;">DAFTAR PENERIMA INSENTIF IMPROVEMENT (SUMBANG SARAN)</h5>
            </td>
        </tr>
    </table>
    <br>
    ...
    <div class="row">
        <div class="col-12">
            <b style="font-size: small;">DAFTAR PENERIMA INSENTIF IMPROVEMENT (SUMBANG SARAN) </b><small
    ...
    <table class="table1">
        <thead>
            <tr>
                ...
                <th style="font-size:x-small;">Voucher</th>
                <th style="font-size:x-small;">Tema Ide</th>
                <th style="font-size:x-small;">TTD</th>
                <th style="font-size:x-small;">Tgl Terima</th>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style=" font-size:xx-small;">{{$i->status_ss}}</td>
                ...
                <td style=" font-size:xx-small;">3,000</td>
